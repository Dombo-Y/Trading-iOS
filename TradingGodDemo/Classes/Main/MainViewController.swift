...
//        list.mj_footer = MJRefreshAutoNormalFooter.init(refreshingTarget: self.self, refreshingAction: #selector(loadMoreDataSenior))
    ...
    func adTwoNum(num1: Int, num2:Int){
        var welcomMessage: String
        welcomMessage = "hello"
        print("哈哈哈\(welcomMessage)")
    }
...
//        let timeString = NSString.lessSecondToDay(seconds: 1672029036994)
//        let timeString = NSString.timeStampToString(timeStamp: 1672029036994)
